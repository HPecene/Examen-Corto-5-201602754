...
def p_instruccion_imprimir(t) :
    'imprimir_instr     : expresion_cadena'
    t[0] =Imprimir(t[1])
...
def p_expresion_logica(t) :
    '''expresion_logica : expresion_numerica MAYOR expresion_numerica
                        ...
                        | expresion_numerica DESIGUAL expresion_numerica'''
    if t[2] == '>'    : t[0] = ExpresionComparadora(t[1], t[3], OPERACION_LOGICA.MAYOR_QUE)
    elif t[2] == '<'  : t[0] = ExpresionComparadora(t[1], t[3], OPERACION_LOGICA.MENOR_QUE)
    elif t[2] == '==' : t[0] = ExpresionComparadora(t[1], t[3], OPERACION_LOGICA.IGUAL)
    elif t[2] == '<>' : t[0] = ExpresionComparadora(t[1], t[3], OPERACION_LOGICA.DIFERENTE)

def p_expresion_and(t) :
    'expresion_logica   : expresion_logica AND expresion_logica'
    t[0] = ExpresionLogistica(t[1], t[3], OPERACION_LOGICA.AND)

def p_expresion_or(t) :
    'expresion_logica   : expresion_logica OR expresion_logica'
    t[0] = ExpresionLogistica(t[1], t[3], OPERACION_LOGICA.OR)

def p_expresion_not(t):
    'expresion_logica : NOT expresion_logica'
    t[0] = ExpresionNegadora(t[2], OPERACION_LOGICA.NOT)

def p_expresion_agrupacion_logica(t):
